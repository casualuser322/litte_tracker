...
urlpatterns = [
    ...
    path(
        "invitation/send/<int:group_id>", views.send_invitation, name="send_invitation"
    ),
    ...
    path(
        "projects/create/<int:group_id>/", views.create_project, name="create_project"
    ),
    path(
        "projects/<int:project_id>/", view=views.project_details, name="project_details"
    ),
    path(
