...
class TestTrackerView:
    ...
    def test_ticket_detail_no_access(self, client, user, ticket):
        other_user = baker.make(
            "accounts.TicketsUser", email="other@example.com"
        )
    ...
    def test_update_ticket_status_ajax(self, client, user, ticket):
        ...
        data = {"task_id": ticket.id, "status": "in_progress"}

        response = client.post(
            reverse(
                "update_task_status", kwargs={"project_id": ticket.project.id}
            ),
    ...
    def test_add_comment(self, client, user, ticket):
        ...
        data = {"text": "Test comment", "add_comment": "Submit"}
    ...
    def test_attachment_upload(self, client, user, ticket):
        ...
        data = {"attached_file": test_file, "add_attachment": "Submit"}
    ...
    def test_invalid_attachment_upload(self, client, user, ticket):
        ...
        data = {"attached_file": invalid_file, "add_attachment": "Submit"}
